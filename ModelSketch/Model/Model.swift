...
//        let distanceNodeAB = MetaDistanceQuantityNode(nodeA: nodeA, nodeB: nodeB)
//        self.metaGraph.add(node: distanceNodeAB)
//        
//        let distanceNodeCD = MetaDistanceQuantityNode(nodeA: nodeC, nodeB: nodeD, maxNode: distanceNodeAB)
